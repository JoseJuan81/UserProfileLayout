...
__vue_render__._withStripped = true;
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-1581fb32_0", { source: ".dl-layout-main-container {\n  height: 100%;\n}\n.dl-container-layout {\n  align-items: flex-start;\n  display: flex;\n  justify-content: flex-start;\n}\n.dl-aside-container {\n  flex-basis: 17%;\n}\n.dl-section-container {\n  flex-basis: auto;\n  flex-grow: 1;\n}\n.dl-menu-movil {\n  background-color: white;\n  bottom: 0;\n  left: -110%;\n  position: absolute;\n  top: 0;\n  transition: left 200ms ease-in-out;\n  z-index: 99;\n}\n.dl-show-menu-movil {\n  left: 0%;\n}\n\n/*# sourceMappingURL=user-profile-layout.vue.map */", map: {"version":3,"sources":["/Users/frontend/Documents/JJ/dl-components/my-components/UserProfileLayout/src/components/user-profile-layout.vue","user-profile-layout.vue"],"names":[],"mappings":"AA+DA;EACA,YAAA;AC9DA;ADiEA;EACA,uBAAA;EACA,aAAA;EACA,2BAAA;AC9DA;ADiEA;EACA,eAAA;AC9DA;ADiEA;EACA,gBAAA;EACA,YAAA;AC9DA;ADiEA;EACA,uBAAA;EACA,SAAA;EACA,WAAA;EACA,kBAAA;EACA,MAAA;EACA,kCAAA;EACA,WAAA;AC9DA;ADiEA;EACA,QAAA;AC9DA;;AAEA,kDAAkD","file":"user-profile-layout.vue","sourcesContent":["<template>\n\t<div class=\"dl-layout-main-container\">\n\t\t<div class=\"dl-container-layout\">\n\t\t\t<aside class=\"dl-aside-container\" v-show=\"!movil\">\n\t\t\t\t<slot name=\"aside\"></slot>\n\t\t\t</aside>\n\t\t\t<section class=\"dl-section-container\">\n\t\t\t\t<slot name=\"main-content\"></slot>\n\t\t\t</section>\n\t\t</div>\n\t\t<div\n\t\t\t:class=\"[\n\t\t\t\t'dl-menu-movil',\n\t\t\t\t{ 'dl-show-menu-movil': show && movil },\n\t\t\t]\"\n\t\t>\n\t\t\t<slot name=\"menu-movil\"></slot>\n\t\t</div>\n\t</div>\n</template>\n<script>\n\nfunction mounted() {\n\tthis.movil = window.innerWidth <= this.breakPoint;\n\twindow.addEventListener('resize', this.handlerResize);\n}\n\nfunction beforeDestroy() {\n\twindow.removeEventListener('resize', this.handlerResize);\n}\n\nfunction handlerResize() {\n\tthis.movil = window.innerWidth <= this.breakPoint;\n}\n\nfunction data() {\n\treturn {\n\t\tmovil: false,\n\t};\n}\n\nexport default {\n\tname: 'user-profile-layout',\n\tbeforeDestroy,\n\tdata,\n\tmethods: {\n\t\thandlerResize,\n\t},\n\tmounted,\n\tprops: {\n\t\tbreakPoint: {\n\t\t\tdefault: 768,\n\t\t\ttype: Number,\n\t\t},\n\t\tshow: {\n\t\t\tdefault: false,\n\t\t\ttype: Boolean,\n\t\t},\n\t},\n};\n</script>\n\n<style lang=\"scss\">\n\t.dl-layout-main-container {\n\t\theight: 100%;\n\t}\n\n\t.dl-container-layout {\n\t\talign-items: flex-start;\n\t\tdisplay: flex;\n\t\tjustify-content: flex-start;\n\t}\n\n\t.dl-aside-container {\n\t\tflex-basis: 17%;\n\t}\n\n\t.dl-section-container {\n\t\tflex-basis: auto;\n\t\tflex-grow: 1;\n\t}\n\n\t.dl-menu-movil {\n\t\tbackground-color: white;\n\t\tbottom: 0;\n\t\tleft: -110%;\n\t\tposition: absolute;\n\t\ttop: 0;\n\t\ttransition: left 200ms ease-in-out;\n\t\tz-index: 99\n\t}\n\n\t.dl-show-menu-movil {\n\t\tleft: 0%;\n\t}\n</style>\n",".dl-layout-main-container {\n  height: 100%;\n}\n\n.dl-container-layout {\n  align-items: flex-start;\n  display: flex;\n  justify-content: flex-start;\n}\n\n.dl-aside-container {\n  flex-basis: 17%;\n}\n\n.dl-section-container {\n  flex-basis: auto;\n  flex-grow: 1;\n}\n\n.dl-menu-movil {\n  background-color: white;\n  bottom: 0;\n  left: -110%;\n  position: absolute;\n  top: 0;\n  transition: left 200ms ease-in-out;\n  z-index: 99;\n}\n\n.dl-show-menu-movil {\n  left: 0%;\n}\n\n/*# sourceMappingURL=user-profile-layout.vue.map */"]}, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = undefined;
  /* module identifier */
  var __vue_module_identifier__ = "data-v-1581fb32";
  /* functional template */
